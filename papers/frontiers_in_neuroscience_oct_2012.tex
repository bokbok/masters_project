...
Equations (\ref{eq:h_e}, \ref{eq:i_lk}, \ref{eq:a_ek} \& \ref{eq:phi}) represent a system of 8 coupled non-linear partial
...
parametric subspace comprising alterations in the strength of excitatory neurotransmission ($\Gamma_{ee},  \Gamma_{ei}$), variations in the strength and kinetics of inhibitory neurotransmission ($\Gamma_{ii},  \Gamma_{ie}, \epsilon_{ii}, \epsilon_{ie}$),
