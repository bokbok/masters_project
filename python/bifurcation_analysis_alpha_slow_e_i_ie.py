...
#show()
print "PP"
run.displayPhasePlane2D('slow_e', 'i_ie', fig = "2")
...
print "Cont"
cont2f = frozen.searchForBifurcations('slow_e', 'i_ie', dir = '+', steps = 3000).display(fig = "2")
print "done - forward"
gc.collect()
cont2r = frozen.searchForBifurcations('slow_e', 'i_ie', dir = '-', steps = 50).display(fig = "2")
print "done - rev"
