...
run.run([0, 10]).displayPhasePlane2D('slow_i', 'h_e', fig = "2")
print "Done"
...
print "Cont"
cont2f = frozen.searchForBifurcations('slow_i', 'h_e', dir = '+', steps = 1000).display(fig = "2")
print "done - forward"
gc.collect()
#cont2r = frozen.searchForBifurcations('slow_i', 'h_e', dir = '-', steps = 50).display(fig = "2")
print "done - rev"
